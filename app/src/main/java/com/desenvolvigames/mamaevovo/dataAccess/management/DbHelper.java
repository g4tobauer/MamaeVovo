...
public class DbHelper extends SQLiteOpenHelper {
    ...
    " )";
    private static final String SQL_CREATE_MOVEMENTDATE = "CREATE TABLE " + Contracts.MovementDateEntry.TABLE_NAME +
    " (" +
        Contracts.SalesOrderSubItemByItemEntry._ID + INTEGER_TYPE + " PRIMARY KEY" + COMMA_SEP +
        Contracts.MovementDateEntry.COLUMN_NAME_DATE + TEXT_TYPE +
    " )";
    ...
    private static final String SQL_DELETE_MOVEMENTDATE = "DROP TABLE IF EXISTS " + Contracts.MovementDateEntry.TABLE_NAME;
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(SQL_CREATE_MOVEMENTDATE);
    }
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL(SQL_DELETE_MOVEMENTDATE);
        onCreate(db);
    }
